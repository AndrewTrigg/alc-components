...
function PrimaryButton(_a) {
    ...
    return jsxRuntime.jsxs(MUIButton__default['default'], __assign({ className: classes.root, disabled: disabled, variant: "outlined" }, { children: [children, "This is cool as hell"] }), void 0);
}
